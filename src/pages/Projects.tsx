        ...
        {projectData.map((project, index) => (
          ...
          >
            ...
            <div className="p-5 md:p-6">
              {/* Title */}
              <h3 className="text-lg md:text-xl font-bold text-neutral-100 mb-3 transition-colors duration-300" style={{ fontFamily: "'Inter', sans-serif" }}>
                {project.title}
              </h3>

              {/* Description */}
              <p className="text-sm md:text-base text-neutral-400 mb-4 leading-relaxed line-clamp-3" style={{ fontFamily: "'Inter', sans-serif" }}>
                {project.description}
              </p>
              ...
              <div className="flex gap-3 pt-2">
                ...
                {project.githubLink && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`${project.demoLink ? '' : 'flex-1'} inline-flex items-center justify-center gap-2 px-4 py-2.5 border border-neutral-700 text-neutral-300 text-sm font-medium rounded-lg hover:bg-neutral-800 hover:text-neutral-100 transition-all duration-300`}
                  >
